...
1. [OpenStudioLandscapes-Dagster](#openstudiolandscapes-dagster)
   1. [Brief](#brief)
...
SBOMs for the different Python interpreters defined in [`.noxfile.VERSIONS`](https://github.com/michimussato/OpenStudioLandscapes-Dagster/tree/main/noxfile.py) will be created in [`.sbom`](https://github.com/michimussato/OpenStudioLandscapes-Dagster/tree/main/.sbom)
...
| `DOCKER_USE_CACHE`                      | `bool` |
| `CONFIGS_ROOT`                          | `str`  |
| `DAGSTER_DEV_PORT_HOST`                 | `str`  |
| `DAGSTER_DEV_PORT_CONTAINER`            | `str`  |
| `DAGSTER_ROOT`                          | `str`  |
| `DAGSTER_HOME`                          | `str`  |
| `DAGSTER_HOST`                          | `str`  |
| `DAGSTER_WORKSPACE`                     | `str`  |
| `POSTGRES_SERVICE_NAME`                 | `str`  |
| `POSTGRES_USER`                         | `str`  |
| `POSTGRES_PASSWORD`                     | `str`  |
| `POSTGRES_DB`                           | `str`  |
| `PGDATA`                                | `str`  |
| `POSTGRES_PORT_HOST`                    | `str`  |
| `POSTGRES_PORT_CONTAINER`               | `str`  |
| `POSTGRES_DATABASE_INSTALL_DESTINATION` | `str`  |
